    ...
    <nav className="bg-white dark:bg-gray-900  w-full z-20 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl relative  flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center">
          <img src={transIct} alt="TransIct Logo" />
        </a>
        <div className="flex gap-6 absolute top-12 right-4 md:order-2 lg:relative lg:top-0 lg:right-0">
          <button
            type="button"
            className="hidden xl:flex text-white bg-[#800000] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Get started
          </button>
          <button
            type="button"
            className="hidden xl:inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-full bg-[#EFF1F5] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
